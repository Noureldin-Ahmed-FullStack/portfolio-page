...
export default function ProjectCard({ title, link, describtion, imageUrl,tooltip }) {
  return (
    <Col sm={6} md={4} className='d-flex align-items-center'>

      <Tooltip followCursor TransitionComponent={Zoom} title={tooltip? tooltip: "Check out this project!"}>
        <div className=''>

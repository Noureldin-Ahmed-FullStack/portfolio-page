          ...
          <Box sx={{ flexGrow: 0 }}>
            ...
            <div className='d-flex'>
              ...
              <Tooltip followCursor TransitionComponent={Zoom} title="Github">
                <a href='https://github.com/Noureldin-Ahmed-FullStack' target='_blank' className="nav-link cursor mx-2" ><i className='fa-brands fa-github'></i></a>
              </Tooltip>
              <Tooltip followCursor TransitionComponent={Zoom} title="LinkedIn">
                <a href='https://www.linkedin.com/in/noureldin-ahmed-7849801a7/' target='_blank' className="nav-link cursor mx-2" ><i className='fa-brands fa-linkedin'></i></a>
              </Tooltip>

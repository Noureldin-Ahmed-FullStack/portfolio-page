            ...
            <Container>
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <ul className="navbar-nav ms-auto font-1">
                        <li className="nav-item myNavColor mx-3"><a className="nav-link cursor" onClick={() => scrollToSection("top")} >HOME</a></li>
                        <li className="nav-item myNavColor mx-3"><a className="nav-link cursor" onClick={() => scrollToSection("about")} >ABOUT</a></li>
                        <li className="nav-item myNavColor mx-3"><a className="nav-link cursor" onClick={() => scrollToSection("courses")} >COURSES</a></li>
                        <li className="nav-item myNavColor mx-3"><a className="nav-link cursor" onClick={() => scrollToSection("projects")} >PROJECT</a></li>
